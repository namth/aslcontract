    ...
    <div class="row">
        <div class="col-sm-12">
            <?php
                ...
                # get only root normal tags
                $tags = $wpdb->get_results("SELECT * FROM $table_name WHERE parentID IS NULL AND tagType = 'normal'");
                ...
                if ($tags) {
                    ...
                    foreach ($tags as $tag) {
                        ...
                        $count = $wpdb->get_var($wpdb->prepare("SELECT COUNT(*) FROM $template_table WHERE tagID = %d", $tag->tagID));
                        ?>
