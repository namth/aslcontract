            ...
            <form id="addnew_template_form" action="" method="post" enctype="multipart/form-data">
                <div class="asl-tab-wizard">
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        <ul class="nav nav-tabs d-sm-flex align-items-center justify-content-center w-100"
                            role="tablist">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link asl_tab p-3" id="tab2" data-bs-toggle="tab" href="#choosefolder"
                                    role="tab" aria-selected="false">Chọn file mẫu</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link asl_tab p-3" id="tab4" data-bs-toggle="tab" href="#datareplace"
                                    role="tab" aria-selected="false">Dữ liệu thay thế</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link asl_tab p-3" id="tab3" data-bs-toggle="tab" href="#filename"
                                    role="tab" aria-selected="false">Tên và vị trí file được tạo</a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content tab-content-basic">
                        <div class="tab-pane fade show active" id="choosefile" role="tabpanel"
                            aria-labelledby="choosefile">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div
                                        class="statistics-details d-flex flex-row gap-3 flex-wrap justify-content-center">

                                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                                            <label for="templateName" class="w165 text-right">Tên mẫu file tài
                                                liệu</label>
                                            <input type="text" class="form-control mxw300" id="templateName"
                                                name="templateName">
                                        </div>

                                        <div class="d-flex justify-content-center w-100">
                                            <a href="#choosefolder"
                                                class="btn btn-info btn-icon-text d-flex align-items-center">
                                                <i class="ph ph-arrow-bend-up-right btn-icon-prepend fa-150p"></i> Tiếp
                                                tục
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="statistics-details d-flex flex-row gap-3 flex-wrap">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                                            ...
                                            <input type="text" class="form-control mxw300" id="google_fileID"
                                                name="google_fileID">
                                        </div>

                                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                                            <label for="tagID" class="w165 text-right">Thư mục template</label>
                                            <select class="form-control js-example-basic-single w300" id="tagID"
                                                name="tagID">
                                                <option value="">-- Chọn thư mục template --</option>
                                                <?php
                                        ...
                                        <div class="form-group d-flex justify-content-center w-100">
                                            <a href="#choosefile"
                                                class="btn btn-inverse-info btn-icon-text me-2 d-flex align-items-center"><i
                                                    class="ph ph-arrow-arc-left btn-icon-prepend"></i> Quay lại</a>
                                            <a href="#datareplace"
                                                class="btn btn-info btn-icon-text d-flex align-items-center">
                                                <i class="ph ph-arrow-bend-up-right btn-icon-prepend fa-150p"></i> Tiếp
                                                tục
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="statistics-details d-flex flex-row gap-3 flex-wrap">
                                        ...
                                        <div id="replaceArea"
                                            class="d-flex justify-content-center w-100 flex-column gap-3 align-items-center">

                                        </div>

                                        <div
                                            class="d-flex justify-content-center w-100 flex-column gap-3 align-items-center">
                                            <div id="datasource_action"
                                                class="asl-dash-btn btn-inverse-info d-flex gap-5 w-100 justify-content-center">
                                                <a href="#" id="add_datasource" class="d-flex nav-link"><i
                                                        class="ph ph-plugs icon-md"></i></a>
                                                <a href="#" class="add_formula d-flex nav-link" data-custom="formula"><i
                                                        class="ph ph-math-operations icon-md"></i></a>
                                                <a href="#" class="add_formula d-flex nav-link" data-custom="date"><i
                                                        class="ph ph-calendar-plus icon-md"></i></a>
                                                <a href="#" class="add_formula d-flex nav-link" data-custom="blank"><i
                                                        class="ph ph-align-left-simple icon-md"></i></a>
                                                <a href="#" class="add_formula d-flex nav-link"
                                                    data-custom="multiblock"><i
                                                        class="ph ph-diamonds-four icon-md"></i></a>
                                        ...
                                        <div class="form-group d-flex justify-content-center w-100">
                                            <a href="#choosefolder"
                                                class="btn btn-inverse-info btn-icon-text me-2 d-flex align-items-center"><i
                                                    class="ph ph-arrow-arc-left btn-icon-prepend"></i> Quay lại</a>
                                            <a href="#filename"
                                                class="btn btn-info btn-icon-text d-flex align-items-center"><i
                                                    class="ph ph-arrow-arc-right btn-icon-prepend"></i> Tiếp tục</a>
                                ...
                                <div class="col-sm-12">
                                    <div class="statistics-details d-flex flex-row gap-3 flex-wrap">
                                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                                            ...
                                            <select class="form-control js-example-basic-single w300" id="googleTagID"
                                                name="googleTagID">
                                                ...
                                                if ($google_tags) {
                                                    foreach ($google_tags as $google_tag) {
                                                        echo '<option value="' . $google_tag->tagID . '">' . esc_html(get_tag_path($google_tag->tagID)) . '</option>';
                                                    }
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center w-100 gap-3">
                                            <label for="gDestinationFilename" class="w165 text-right">Tên file sau khi
                                                tạo tự động</label>
                                            <input type="text" class="form-control mxw300" id="gDestinationFilename"
                                                name="gDestinationFilename">
                                        </div>
                                        ...
                                        <div class="form-group d-flex justify-content-center w-100">
                                            <a href="#datareplace"
                                                class="btn btn-inverse-info btn-icon-text me-2 d-flex align-items-center">
                                                <i class="ph ph-arrow-bend-up-left btn-icon-prepend fa-150p"></i> Quay
                                                lại
                                            </a>
                                            <button type="submit"
                                                class="btn btn-info btn-icon-text d-flex align-items-center">
                                                <span class="mdi mdi-creation-outline btn-icon-prepend fa-150p"></span>
                                                Tạo template mới
                                            </button>
                                        </div>
                                    </div>
