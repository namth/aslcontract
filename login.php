...
<body>
    <div class="container-scroller">
        <div class="container-fluid page-body-wrapper full-page-wrapper">
            <div class="content-wrapper d-flex align-items-center auth px-0 flex-column justify-content-center"
                style="background: url('<?php echo get_template_directory_uri(); ?>/img/bg.webp') no-repeat center center; background-size: cover;">
